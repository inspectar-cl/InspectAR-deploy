...
func (s *ActivoService) ObtenerActivo(ctx context.Context, activoID int) (*models.Activo, error) {
	return s.activoRepo.GetActivo(ctx, activoID)
}

func (s *ActivoService) AgregarSensor(ctx context.Context, activoID int, sensor models.Sensor) error {
